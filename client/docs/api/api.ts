...
export default {
  ...
  info: {
    ...
    description: "API reference for [https://jkasper-url-shortener-app.herokuapp.com/](https://jkasper-url-shortener-app.herokuapp.com/).\n",
    version: p.version
  },
  servers: [
    {
      url: "https://jkasper-url-shortener-app.herokuapp.com/api/"
    }
  ],
  tags: [
    {
